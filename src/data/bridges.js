...
export const bridges = [
  ...
  },
  {
    ...
    outcome: 'Collapsed',
    primaryFactor: 'soft',
    clue: 'Long ramps on soft riverbank fill',
    factors: ['Long approach ramps', 'Saturated, soft riverbank fill', 'Liquefaction-prone ground'],
    reason:
      'Its long approach ramps sit on saturated riverbank fill near the epicenter. Soft ground can lose strength and flow during shaking, dropping the spans.',
